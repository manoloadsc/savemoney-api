...
1 = Doações 2 = Cursos 3 = Viagens 4 = Diversão 5 = Salário 6 = Aluguel 7 = Auxílio 8 = Rendimentos 9 = Alimentação 10 = Transporte 11 = Moradia 12 = Lazer 13 = Educação 14 = Roupas 15 = Acessórios 16 = Presentes 17 = Animais 18 = Beleza, 19 = Outros 20 = Investimento 21 = Poupança 22 = Cofrinho 23 = Reserva para Viagem 24 = Reserva para Sonhos 25 = Mentoria 26 = Assessoria 27 = Faculdade
`.trim()
        }
      },
  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        value: {
          type: "number",
          description: "Valor associado à notificação (pode ser zero, se não especificado)",
        },
      },
      required: [
        "period",
  ...
  function: {
    ...
    parameters: {
      ...
      properties: {
        ...
        value: {
          type: "number",
          description: "Novo valor da notificação (pode ser zero)",
        },
        description: {
          type: "string",
...
let tools: ChatCompletionFunctionTool[] = [
  newTransactionTool,
