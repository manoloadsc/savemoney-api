...
export default async function dashboardRoutes(app: FastifyInstance) {
    ...
    app.get("", {
        ...
        res.status(200).send({ 
            receitas : formatCurrency(dashboard.receitas, dashboard.currency), 
            gastos : formatCurrency(dashboard.gastos, dashboard.currency),
            balance : formatCurrency(dashboard.balance, dashboard.currency),
            total : formatCurrency(dashboard.total, dashboard.currency),
